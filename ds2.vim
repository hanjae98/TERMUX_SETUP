...
" In Python, identifier is case of built-in functions, method names, etc.
hi Identifier   cterm=bold ctermfg=lightblue
" for, if, return
hi Statement	cterm=bold ctermfg=yellow
" In C comment, a constant when it starts with zero
" then the first zero's color 
" include <>
